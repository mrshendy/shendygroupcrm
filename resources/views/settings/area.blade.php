                        ...
                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th data-ordering="false">{{ trans('settings_trans.name_governmentes') }}</th>
                                                        ...
                                                        <form action="{{ route('area.update','test')}}" method="post" >
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <label class="my-1 mr-2" for="inlineFormCustomSelectPref">{{ trans('settings_trans.government_select') }}</label>
                                                                            ...
                                                                            onchange="get_city($(this).val())"  onvolumechange="get_city($(this).val())">
                                                                                <option value="" selected disabled>{{ trans('settings_trans.government_select') }}</option>
