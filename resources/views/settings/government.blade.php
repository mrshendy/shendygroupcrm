    ...
    <div class="col-12">
                    ...
                    <div class="card-header">
                       ...
                       {{-- Message --}}
                        ...
                        <div class="d-grid gap-2" >
                            <button data-bs-toggle="modal" data-bs-target="#signupModals" class="btn btn-primary waves-effect waves-light" type="button">{{ trans('settings_trans.add_new_government') }}</button>
                        </div>
                        ...
                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$i}}</td>
                                    <td>{{$government->id}}</td>
                                    <td>{{$government->getTranslation('name','ar')}}</td>
                                    <td>{{$government->getTranslation('name','en')}}</td>
                                    ...
                                    <td>
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li><button data-bs-toggle="modal" data-bs-target="#signupModals{{$government->id}}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</button></li>
                                                <li><button data-bs-toggle="modal" data-bs-target="#signupModal{{$government->id}}" class="dropdown-item edit-item-btn"> <i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</button></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
                                          <!-- edit -->
                                          <div id="signupModals{{$government->id}}" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;" >
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('government.update','test')}}" method="post" >
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="name_en" name="name_en" value="{{$government->getTranslation('name','en')}}">
                                                            </div>
                                                            <div class="form-group">
                                        ...
                                        <div id="signupModal{{$government->id}}" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content border-0 overflow-hidden">
                                                    <div class="modal-header p-3">
                                                        <h4 class="card-title mb-0">{{ trans('settings_trans.massagedelete_Government') }}</h4>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body text-center p-5">
                                                        ...
                                                        <div class="mt-4 pt-4">
                                                            ...
                                                            <p class="text-muted">   {{ trans('settings_trans.massagedelete_p') }}{{$government->name}}</p>
                                                            <!-- Toogle to second dialog -->
                                                            <form action="{{ route('government.destroy','test')}}" method="post">
                                                                {{ method_field('delete') }}
                                                                {{ csrf_field() }}
                                                                <input  class="form-control" id="id" name="id" value="{{$government->id}}" type="hidden">

                                                            <button class="btn btn-warning" data-bs-target="#secondmodal" data-bs-toggle="modal" data-bs-dismiss="modal">
                                                                {{ trans('settings_trans.massagedelete_Government') }}
                                                            </button>
                                                           </form>
                                                        </div>
                                                    </div>
        ...
        <div id="signupModals" class="modal fade" tabindex="-1" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 overflow-hidden">
                    <div class="modal-header p-3">
                        <h4 class="card-title mb-0">{{ trans('settings_trans.add_new_government') }}</h4>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{route('government.store')}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="id_country" id="id_country" class="form-select" data-choices data-choices-sorting="true" required>
                                    ...
                                    @foreach ($countries as $government)
