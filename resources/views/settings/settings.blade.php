            ...
            <div class="row g-3">
                    ...
                    <div class="card card-body text-center h-100">
                        <div class="avatar-md mx-auto mb-3">
                            <div class="avatar-title bg-soft-light border border-info p-2 text-success rounded">
                                <lord-icon src="{{URL::asset('assets/images/icon/nnbhwnej.json')}}" 
                        ...
                        <a href="javascript:void(0);" class="btn btn-info mt-2">{{ trans('settings_trans.Go_to_settings_now') }}</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-lg-6">
                    <div class="card card-body text-center h-100">
                        <div class="avatar-md mx-auto mb-3">
                            <div class="avatar-title bg-soft-light border border-info p-2 text-success rounded">
                                <lord-icon src="{{URL::asset('assets/images/icon/oqhlhtfq.json')}}"
                                          trigger="loop" delay="500"
                        ...
                        <a href="{{ url('/nationalities_settings') }}" class="btn btn-info mt-2">{{ trans('settings_trans.Go_to_settings_now') }}</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-lg-6">
                    <div class="card card-body text-center h-100">
                        <div class="avatar-md mx-auto mb-3">
                            <div class="avatar-title bg-soft-light border border-info p-2 text-success rounded">
                                <lord-icon src="{{URL::asset('assets/images/icon/oaflahpk.json')}}"
                                          trigger="loop" delay="500"
                        ...
                        <a href="{{ url('/places_settings') }}" class="btn btn-info mt-2">{{ trans('settings_trans.Go_to_settings_now') }}</a>
                    </div>
                </div>
                ...
                <div class="col-xxl-3 col-lg-6">
                    <div class="card card-body text-center h-100">
                        <div class="avatar-md mx-auto mb-3">
                            <div class="avatar-title bg-soft-light border border-info p-2 text-success rounded">
                                <lord-icon src="{{URL::asset('assets/images/icon/hpnrikyx.json')}}"
                                          trigger="loop" delay="500"
                        ...
                        <a href="{{ url('/currencies') }}" class="btn btn-info mt-2">{{ trans('settings_trans.Go_to_settings_now') }}</a>
                    </div>
                </div>

                <!-- Finance Settings (Full Width) -->
                <div class="col-9">
