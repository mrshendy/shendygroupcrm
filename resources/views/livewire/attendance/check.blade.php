        ...
        <div class="card shadow-sm border-0 rounded-3 p-4">
            <div class="card-body">
                ...
                @if (empty($attendanceToday))
                    ...
                    <button wire:click="checkIn" class="btn btn-success btn-lg rounded-pill px-5 py-3 shadow-sm w-100">
                ...
                @else
                    ...
                    <div class="text-start mb-4">
                        ...
                        @else
                            <div class="mt-4 pt-3">
                                <button wire:click="checkOut" class="btn btn-danger btn-lg rounded-pill px-5 py-3 shadow-sm w-100">
