        ...
        <div class="card-body p-5">
            <form wire:submit.prevent="save">
                ...
                <div class="mb-4">
                    ...
                    <textarea wire:model.defer="description" class="form-control textarea-custom" rows="3"
                ...
                <div class="mb-4">
                    ...
                    <textarea wire:model.defer="details" class="form-control textarea-custom" rows="5"
                        placeholder="اكتب التفاصيل الكاملة للمشروع..."></textarea>
                </div>
