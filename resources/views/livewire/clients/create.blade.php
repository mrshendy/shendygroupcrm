                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" wire:model.lazy="clients.{{ $index }}.name" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control" wire:model.lazy="clients.{{ $index }}.email">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="tel" class="form-control" wire:model.lazy="clients.{{ $index }}.phone">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="mdi mdi-briefcase-account-outline"></i></span>
                                        <input type="text" class="form-control" wire:model.lazy="clients.{{ $index }}.job">
                                    </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" wire:model.lazy="clients.{{ $index }}.address">
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-select" wire:model="clients.{{ $index }}.country_id">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" wire:model.lazy="clients.{{ $index }}.contact_name">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" wire:model.lazy="clients.{{ $index }}.contact_job">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" class="form-control" wire:model.lazy="clients.{{ $index }}.contact_phone">
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" wire:model.lazy="clients.{{ $index }}.contact_email">
                                </div>
                                ...
                                <div class="form-check form-switch ps-0">
                                    <div class="d-flex align-items-center">
                                        <input class="form-check-input ms-0 me-2" type="checkbox"
                                            wire:model="clients.{{ $index }}.is_main_contact"
                                            id="mainContact{{ $index }}">
                                        <label class="form-check-label fw-bold d-flex align-items-center" for="mainContact{{ $index }}">
