    ...
    <div class="card shadow-sm border-0 overflow-hidden">
                    ...
                    <div class="position-relative">
                        ...
                        @else
                            <img src="{{ asset('images/default-avatar.png') }}" 
                                 ...
                                 alt="صورة افتراضية">
                        @endif
                        <span class="position-absolute bottom-0 start-50 translate-x--50 bg-{{ $employee->status == 'مفعل' ? 'success' : 'danger' }} text-white px-2 py-1 rounded-pill small">
                            {{ $employee->status }}
                        </span>
                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="bg-light p-3 rounded">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        ...
                                        <strong class="text-success">{{ number_format($employee->salary, 2) }} جنيه</strong>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="card-footer bg-light d-flex justify-content-between">
            <small class="text-muted">
                آخر تحديث: {{ $employee->updated_at->diffForHumans() }}
            </small>
