        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{ trans('user_management_trans.role_list')}}</h5>
                    {{-- Message --}}
                ...
                <div class="d-flex justify-content-between">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            @can('role-create')
                                <a  style="margin: 10px;" class="btn btn-outline-success waves-effect waves-light shadow-none" href="{{ route('roles.create') }}">{{ trans('user_management_trans.role_create') }}</a>
                            @endcan
                        </div>
                    </div>
                    <br>
